...
options:
    ...
    odata_filter:
        description:
            ...
            - Sampel as startswith(userPrincipalName, 'test1').
        type: str
    all:
        description:
...
EXAMPLES = '''
    ...
    - name: Using attribute proxyAddresses - a collection
      azure.azcollection.azure_rm_aduser_info:
        ...
        attribute_value: usertest
        tenant: xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx

    - name: Using Filter mailNickname
      azure.azcollection.azure_rm_aduser_info:
        odata_filter: startswith(displayName, 'test.test')
        tenant: xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
    ...
    def exec_module(self, **kwargs):
        ...
        try:
            ...
            if self.user_principal_name is not None:
                ...
                ad_users = client.get(url).json()['value']
            elif self.all:
                ad_users = client.get('/users/').json()['value']
